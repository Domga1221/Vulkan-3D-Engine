...
namespace lve {
    ...
    public:
        class Builder {
        public:
            Builder(LveDevice& lveDevice) : lveDevice{ lveDevice } {} // Blueprint object

            Builder& addBinding(
                uint32_t binding,
                VkDescriptorType descriptorType,
                VkShaderStageFlags stageFlags,
                uint32_t count = 1); // bindings can hold multiple descriptors
    ...
    public:
        ...
        public:
            ...
            Builder& setPoolFlags(VkDescriptorPoolCreateFlags flags); // behavior of pool object
    ...
    private:
        ...
        friend class LveDescriptorWriter; // LveDescriptorWriter has access to private members of LveDescriptorPool
    };
