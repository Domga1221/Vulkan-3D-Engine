...
namespace lve {
    ...
    // sets the projectionMatrix member to the orthographic projection matrix
    ...
    // sets the projectionMatrix member to the perspective projection matrix
    ...
    void LveCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
        ...
        const glm::vec3 u{ glm::normalize(glm::cross(w, up)) }; // orthonomal bases, length 1, 90 degree angle
